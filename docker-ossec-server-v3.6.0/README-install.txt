Installation d'un contenteur ossec-server :
	...
	3. 	Import de l'image "ossec-server". L'image "ossec-server" est basé sur une image "alpine" dans lequel a été
		ajouté :
			- le paquet ossec-hids-3.6.0-r0.apk
			- le paquet ossec-hids-openrc-3.6.0-r0.apk
			- le paquet ossec-hids-server-3.6.0-r0.apk
			- le paquet tzdata ("apk add dzdata") pour synchroniser l'horloge sur Paris. Il a été supprimé 
ensuite.
